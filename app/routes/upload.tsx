...
const Upload = () => {
  ...
  const handleAnalyze = async ({
    ...
    if (!uploadedFile)
      return setStatusText("Erreur: échec du téléchargement du fichier");
    ...
    if (!uploadedImage)
      return setStatusText("Erreur: échec du téléchargement de l'image");
    ...
    // Enlever les ```json et ``` puis parser
    data.feedback = JSON.parse(feedbackText.replace(/```json\n?|```/g, ""));
    await kv.set(`resume:${uuid}`, JSON.stringify(data));
    ...
    <main className="bg-[url('/images/bg-main.svg')] bg-cover">
      ...
      <section className="main-section">
        <div className="page-heading py-16">
          <h1>Retroaction intelligente pour votre emploi de rêve</h1>
          {isProcessing ? (
            <>
              <h2>{statusText}</h2>
            ...
            <h2>
              Déposez votre CV pour une note ATS et des conseils d'amélioration
            </h2>
          )}
          {!isProcessing && (
            <form
            ...
            >
              ...
              <div className="form-div">
                <label htmlFor="uploader">Télécharger le CV</label>
